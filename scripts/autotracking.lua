...
AUTOTRACKER_ENABLE_DEBUG_LOGGING_LOGIC = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
...
AUTOTRACKER_ENABLE_DEBUG_LOGGING_ACCESS = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
AUTOTRACKER_ENABLE_DEBUG_LOGGING_LOCATION = true and AUTOTRACKER_ENABLE_DEBUG_LOGGING
